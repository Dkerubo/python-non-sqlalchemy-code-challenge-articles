class Article:
    all = []  # Changed from 'articles' to 'all'
    ...
    def __init__(self, author, magazine, title):
        ...
        self._title = title
        Article.all.append(self)  # Changed from 'articles' to 'all'
...
class Magazine:
    all = []  # Changed from 'magazines' to 'all' for consistency
    ...
    def __init__(self, name, category):
        ...
        Magazine.all.append(self)  # Changed from 'magazines' to 'all'
